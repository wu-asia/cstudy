...
//	COLORREF color;
//};
//COLORREF color[256] = { RGB(255,32,83),RGB(252,222,250),RGB(255,0,0),RGB(225,2,2),RGB(255,2,2),RGB(255,0,8),RGB(255,5,5) };
//const int xScreen = 1200;
//const int yScreen = 800;
//const double PI = 3.142653519;
...
//	for (double radian = 0.1; radian <= 2 * PI; radiam += 0.005)
//	{
...
//			{
//				COLORREF color = colors[creat_radom(0, 6)];
//				points[index].color = RGB(GetRValue(color) / lightness, GetValue(color) / lightness, GetBValue(color) / lightness);
//				points[index].x = size * origin_points[i].y + creat_random(-4, 4);
...
//			double distance_increase = -0.09 * distance * distance + 0.35714 * distance + 5;
...
//			{
//				if ((creat_random(0, 100) / 100.0 > 0.6 && size >= 20) || (size < 20 && creat_radom(0, 100) / 100.0>0.95))
//				{
//					double x, y;
//					if (size >= 20)
//					{
...
//					}
//					setfillcolor(color[creat_random(0, 6)]);
//
